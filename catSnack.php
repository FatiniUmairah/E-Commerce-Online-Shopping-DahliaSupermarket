  ...
  {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="catSnack.php"</script>';  
           }  
      }  
      else  
      {  
  ...
  <header>
   ...
   <div class="side-bar">
    <div class="menu">
      <div class="item">
        ...
        <a href="catSnack.php" style="color:grey; background-color:#F9E0DB"><b>Snacks</b></a>
   ...
   <br/>
       <div class="container" style="width:700px;">   
            ...
            $query = "SELECT * FROM product WHERE ProductCategory = 'Snacks' ORDER BY ProductID ASC";  
            $result = mysqli_query($connect, $query);  
            if(mysqli_num_rows($result) > 0){  
                while($row = mysqli_fetch_array($result))  {  
            ?>  
            <div class="col-md-4">  
                <form method="post" action="catSnack.php?ProductID=<?=$row['ProductID'] ?>">
