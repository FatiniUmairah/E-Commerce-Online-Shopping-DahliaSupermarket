  ...
  {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="catDairyEgg.php"</script>';  
           }  
      }  
      else  
      {  
...
<head>
  ...
  <title>Promotion Dairy & Eggs</title>  
  ...
  <header>
   ...
   <div class="side-bar">
    <div class="menu">
      <div class="item">
        ...
        <a href="catDairyEgg.php" style="color:grey; background-color:#F9E0DB"><b>Dairy & Eggs</b></a>
   ...
   <br/>
       <div class="container" style="width:700px;">   
            <?php
            $query = "SELECT * FROM product WHERE ProductCategory = 'Dairy Eggs' ORDER BY ProductID ASC";  
            ...
            ?>  
            <div class="col-md-4">  
                <form method="post" action="catDairyEgg.php?ProductID=<?=$row['ProductID'] ?>">
