  ...
  {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="catPantry.php"</script>';  
           }  
      }  
      else  
      {  
  ...
  <header>
   ...
   <div class="side-bar">
    <div class="menu">
      <div class="item">
        ...
        <a href="catPantry.php" style="color:grey; background-color:#F9E0DB"><b>Pantry</b></a>
   ...
   <br/>
       <div class="container" style="width:700px;">   
            ...
            $query = "SELECT * FROM product WHERE ProductCategory = 'Pantry' ORDER BY ProductID ASC";  
            ...
            ?>  
            <div class="col-md-4">  
                <form method="post" action="catPantry.php?ProductID=<?=$row['ProductID'] ?>">
