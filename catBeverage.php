  ...
  {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="catBeverage.php"</script>';  
           }  
      }  
      else  
      {  
...
<head>
  ...
  <title>Promotion Baverage</title>  
  ...
  <header>
   ...
   <div class="side-bar">
    <div class="menu">
      <div class="item">
        ...
        <a href="catBeverage.php" style="color:grey; background-color:#F9E0DB"><b>Beverages</b></a>
   ...
   <br/>
       <div class="container" style="width:700px;">   
            ...
            $query = "SELECT * FROM product WHERE ProductCategory = 'Beverage' ORDER BY ProductID ASC";  
            ...
            ?>  
            <div class="col-md-4">  
                <form method="post" action="catBeverage.php?ProductID=<?=$row['ProductID'] ?>">
