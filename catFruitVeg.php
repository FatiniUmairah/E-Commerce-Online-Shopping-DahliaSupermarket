...
<head>
  ...
  <title>Promotion Fruits & Vegetables</title>  
  ...
  <header>
   ...
   <div class="side-bar">
    <div class="menu">
      <div class="item">
        <h3>CATEGORY</h3>
        <a href="catFruitVeg.php" style="color:grey; background-color:#F9E0DB"><b>Fruits & Vegetables</b></a>
   ...
   <br/>
      <div class="container" style="width:700px;">   
           ...
           $query = "SELECT * FROM product WHERE ProductCategory = 'Fruit Vegetable' ORDER BY ProductID ASC";  
           ...
           ?>  
          <div class="col-md-4">  
               <form method="post" action="catFruitVeg.php?ProductID=<?=$row['ProductID'] ?>">
