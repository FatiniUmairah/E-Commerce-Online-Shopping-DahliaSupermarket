  ...
  {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="catFlourBakery.php"</script>';  
           }  
      }  
      else  
      {  
...
<head>
  ...
  <title>Promotion Flour & Bakery</title>  
  ...
  <header>
   ...
   <div class="side-bar">
    <div class="menu">
      <div class="item">
        ...
        <a href="catFlourBakery.php" style="color:grey; background-color:#F9E0DB"><b>Flours & Bakery</b></a>
   ...
   <br/>
       <div class="container" style="width:700px;">   
            ...
            $query = "SELECT * FROM product WHERE ProductCategory = 'Flour Bakery' ORDER BY ProductID ASC";  
            ...
            ?>  
            <div class="col-md-4">  
                <form method="post" action="catFlourBakery.php?ProductID=<?=$row['ProductID'] ?>">
