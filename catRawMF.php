  ...
  {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="catRawMF.php"</script>';  
           }  
      }  
      else  
      {  
...
<head>
  ...
  <title>Promotion Raw Material</title>  
  ...
  <header>
   ...
   <div class="side-bar">
    <div class="menu">
      <div class="item">
        ...
        <a href="catRawMF.php" style="color:grey; background-color:#F9E0DB"><b>Raw Material & Frozen</b></a>
   ...
   <br/>
       <div class="container" style="width:700px;">   
            ...
            $query = "SELECT * FROM product WHERE ProductCategory = 'Raw Frozen' ORDER BY ProductID ASC";  
            ...
            ?>  
            <div class="col-md-4">  
                <form method="post" action="catRawMF.php?ProductID=<?=$row['ProductID'] ?>">
