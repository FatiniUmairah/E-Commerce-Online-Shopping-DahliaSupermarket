  ...
  {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="catHealthBeauty.php"</script>';  
           }  
      }  
      else  
      {  
...
<head>
  ...
  <title>Promotion Health & Beauty</title>  
  ...
  <header>
   ...
   <div class="side-bar">
    <div class="menu">
      <div class="item">
        ...
        <a href="catHealthBeauty.php" style="color:grey; background-color:#F9E0DB"><b>Health & Beauty</b></a>
      </div>
    </div>
   </div>
   ...
   <br/>
       <div class="container" style="width:700px;">   
            ...
            $query = "SELECT * FROM product WHERE ProductCategory = 'Health Beauty' ORDER BY ProductID ASC";  
            ...
            ?>  
            <div class="col-md-4">  
                <form method="post" action="catHealthBeauty.php?ProductID=<?=$row['ProductID'] ?>">
